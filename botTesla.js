...
const OyunYaratThagiyevvvv = chatId => {
...
const NesneYenileTjagiyevvvv = (obj, f) => {
	let index = 0
	for (let key in obj) {
		f(key, obj[key], index)
		index++
...
const dbUserAlThagiyevvvv = firstName => {  // KULLANICI ADI, PUAN ALMASI
	return {
		firstName: firstName,
		isPlaying: true,
		answer: null,
